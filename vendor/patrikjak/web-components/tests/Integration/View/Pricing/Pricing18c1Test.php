 ...
 */
class Pricing18c1Test extends TestCase
{
    public function testComponentCanBeRendered(): void
    {
        $view = Blade::render('<<<blade
<x-pjcomponents::pricing.pricing-18c1
    heading="Custom pricing plan"
    tagline="Tagline"
    text="Lorem ipsum dolor sit amet, consectetur adipiscing elit. - 4+ plans"
>
    <x-slot:prices>
